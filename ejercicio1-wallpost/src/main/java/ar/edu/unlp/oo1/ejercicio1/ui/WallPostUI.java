...
public class WallPostUI {
  ...
  private void setUpWindow() {
    ...
    Logger.getLogger("interfaz").log(Level.INFO,"Se inició la ejecución de la app");
  ...
  private void wireComponents() {
    this.like.addActionListener( e -> {
    	Logger.getLogger("interfaz").log(Level.INFO,"Se tocó el like");
      this.wallPost.like();
      this.likesLabel.setText(String.valueOf(this.wallPost.getLikes()));
    });
    
    this.dislike.addActionListener( e -> {
    	Logger.getLogger("interfaz").log(Level.INFO,"Se tocó el dislike");
      this.wallPost.dislike();
      this.likesLabel.setText(String.valueOf(this.wallPost.getLikes()));
    });
    
    this.featuredCheckbox.addActionListener(e -> {
    	Logger.getLogger("interfaz").log(Level.INFO,"Se tocó la caja de featured");
